            ...
            <Animation animation={'fadeInDown'} duration={500}>
                {from === 'waliInformation' && fromUserProfile && data.length !== 0 ? (
                    ...
                    <View
                        ...
                        {data?.find((item: any) => item?.selected) ? data?.map((item: any, index: number) =>
                            item?.selected ? (
                            ...
                            <View>
                                <Text style={Styles.passInfoDes}>{!fromUserProfile ? LanguageKeys.noInterestAndHobbiesSelected : LanguageKeys.noInterestAndHobbiesAvailable}</Text>
                            </View>
                        }
                    </View>
                )}
