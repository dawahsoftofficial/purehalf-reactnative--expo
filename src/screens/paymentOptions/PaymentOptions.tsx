...
const PaymentOptions = (props: any) => {
  ...
  const RenderListIcon = ({ item }: any) => (
    <Image source={item.icon} resizeMode="contain" style={Styles.itemIcon} />
  );
    ...
    <Container style={Styles.container}>
      <View style={{ flex: 1 }}>
        <View style={Styles.headerContainer}>
          ...
          />
          <Text style={Styles.headerTxt}>{LanguageKeys.otherWaysToPay}</Text>
        </View>
        <Animation
          ...
          duration={500}
        >
          <FlatList data={paymentOptionsList} renderItem={renderList} />
        </Animation>
      </View>
    </Container>
  );
