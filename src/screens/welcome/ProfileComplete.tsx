        ...
        >
          ...
          >
            <View
              style={{
                ...Styles.checkCircle,
                backgroundColor: completed ? Colors.theme : 'transparent',
              }}
            >
              {completed && (
                <AntDesign name="check" color={Colors.color2} size={wp(4)} />
              )}
            </View>
    ...
    <Menu>
      ...
      <MenuOptions
        optionsContainerStyle={{
          ...Styles.menuCon,
          marginLeft: Rtl ? wp(8) : wp(isIOS ? 0 : 8),
        }}
      >
        <FlatList data={profileCompleteProgress} renderItem={renderInfoList} />
      </MenuOptions>
    </Menu>
  );
};
