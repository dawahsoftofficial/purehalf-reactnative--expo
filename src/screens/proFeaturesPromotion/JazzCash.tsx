...
const JazzCash = (props: any) => {
    ...
    const storeQuery = () => {
        Api.post(
            EndPoints.storeQuerySupport,
            {
                description: "payment realalted",
                type: 2,
                source: "jazzcash-923330093158"
            },
        ).then(async res => {
        })
            .catch((error) => {
    ...
    return (
        ...
        >
            ...
            <View style={Styles.numberSection}>
                <View style={[Styles.numberFieldCon, { marginVertical: hp(0.8), flexDirection: Rtl ? 'row-reverse' : 'row' }]}>
                    <FontAwesome5 name={Rtl ? 'phone' : 'phone-alt'} color={Colors.color1} size={wp(4)}
                ...
                <View style={[Styles.numberFieldCon, Styles.numberFieldConBorder, { flexDirection: Rtl ? 'row-reverse' : 'row' }]}>
                ...
                <View style={[Styles.numberFieldCon, { flexDirection: Rtl ? 'row-reverse' : 'row' }]}>
                    <Text style={[Styles.description, { alignSelf: 'center' }]}>
                        sendScreenshotDes
                    </Text>
                </View>
...
const Styles = StyleSheet.create({
    ...
    numberSection: {
        borderWidth: 1,
        borderColor: Colors.color44,
        backgroundColor: '#eaa41b33',
        borderRadius: 8,
        marginVertical: hp(2),
    },
    numberFieldCon: {
    ...
    button: {
        backgroundColor: Colors.color46,
        borderRadius: 8,
        height: wp(12),
