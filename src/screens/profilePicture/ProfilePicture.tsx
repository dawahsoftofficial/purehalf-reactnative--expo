...
import { Button, Container, ImagePicker } from '../../components'
import { Animation } from '../../animations'
import { hp, Typography, wp } from '../../global'
import { Colors, Fonts, Images } from '../../res'
import { LanguageKeys } from '../../languages'
import { ApiServices, LOG, StorageManager, flashSuccessMessage, isIOS, useGlobalContext } from '../../services'
...
const ProfilePicture = (props: any) => {
    ...
    return (
        <Container style={Styles.container}>
            <Modal transparent={true} visible={toolTipVisible}>
                <View style={Styles.modalWrapper}>
                    ...
                    <View style={Styles.tootltipTextWrapper}>
                        ...
                        <Text style={Styles.guildlineText}>{`\u2022`} The picture quality should be high and not blurry. The picture should not be your whole body but only the face and upper portion of your body like a passport picture.</Text>
                        <Text style={Styles.guildlineText}>{`\u2022`} The profile picture should be a front facing picture that is clearly visible, avoid sunglasses and should not be facing some other way.</Text>
                        <Text style={Styles.guildlineText}>{`\u2022`} We have already added some instructions on the profile picture screen by clicking on the i icon.</Text>
                        <View style={Styles.pfpContainer}>
                            <View>
                                <Text style={Styles.pfpText}>Incorrect</Text>
                                {currentUser?.gender === "female" ?
                                    <Image source={Images.wrongPFPFemale} style={Styles.pfpImage} />
                            ...
                            <View>
                                ...
                                {currentUser?.gender === "female" ?
                                    <Image source={Images.rightPfpFemale} style={Styles.pfpImage} />
            ...
            <ScrollView
                contentContainerStyle={Styles.scrollConrtainer}
            >
                <>
                        ...
                        </View>
                        {
                            uploading ?
                                ...
                                image?.length !== 0 ?
                                    ...
                                    :
                                    <Ripple style={Styles.addImageCon}
                                        onPress={onAddImagePress}
                                    >
                                        <Image
