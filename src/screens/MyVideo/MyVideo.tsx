import { View, StyleSheet, Image, FlatList, ScrollView, Dimensions, ActivityIndicator } from 'react-native'
...
import { ApiServices, flashErrorMessage, flashSuccessMessage } from '../../services'
...
const MyVideo = (props: any) => {
    ...
    const hideVideoPicker = () => setImagePicker({
        visible: false,
        from: '',
    })
    ...
    const onVideoSelection = (images: any) => {
        ...
        if (images.length !== 0) {
            ...
            }, 'intro_video', []).then(async (res: any) => {
                if (res) {
                        ...
                        <View style={Styles.coverPhoto}>
                            ...
                            {showPlayIcon && (
                                <Ripple
                                    ...
                                    onPress={onPlayPause}
                                >
                                    <Ionicons name='play-outline' size={wp(15)} color={Colors.color2} />
                                </Ripple>
                            )}
