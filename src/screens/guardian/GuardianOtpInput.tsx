import { View, StyleSheet, KeyboardAvoidingView, Text as ReactText } from 'react-native'
...
import { StorageManager, flashErrorMessage, getConversationsOnce, isIOS, useGlobalContext } from '../../services'
    ...
    const onContinuePress = async () => {
        ...
        getConversationsOnce(currentUser?.user?.id, async (snapshot: any) => {
            if (snapshot) {
                ...
                await setData(storageKeys.CONVERSATIONS, conversationsData).then(() => {
