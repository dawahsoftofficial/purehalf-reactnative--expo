...
import { ApiServices, StorageManager, checkEmpty, flashErrorMessage, flashSuccessMessage } from '../../services'
...
const GuardianChangePassword = ({ navigation }: any) => {
    ...
    const onChangeConfirmNewPassword = (text: string) => setConfirmNewPassword(text)
    ...
    const onChangePasswordPress = async () => {
        ...
        if(oldPasswordTrimmed.length < 8 || newPasswordTrimmed.length < 8 || confirmNewPasswordTrimmed.length < 8) {
    ...
    return (
        <Container>
            <Header
                title={LanguageKeys.changePassword}
            ...
            >
                <View style={Styles.container}>
                    ...
                    <Button
                        ...
                        disabled={checkEmpty(oldPassword) || checkEmpty(newPassword) || checkEmpty(confirmNewPassword)}
                        loading={loader}
