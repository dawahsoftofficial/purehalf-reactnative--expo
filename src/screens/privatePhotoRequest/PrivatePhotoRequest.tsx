...
const PrivatePhotoRequest = (props: any) => {
    ...
    const RenderOthersRequestedBtn = () => (
        <Ripple style={{
            ...Styles.topBarBtn,
            backgroundColor: selectedTopBarBtn === 'othersRequests' ? Colors.theme : Colors.color2,
        }}
            onPress={onTopBarPress.bind(null, 'othersRequests')}
        >
            <Text style={{
                ...Styles.topBarBtnTxt,
                color: selectedTopBarBtn === 'othersRequests' ? Colors.color2 : Colors.color1
            }}>
    ...
    const RenderYouRequested = () => (
        <Ripple style={{
            ...Styles.topBarBtn,
            backgroundColor: selectedTopBarBtn === 'yourRequests' ? Colors.theme : Colors.color2,
        }}
            onPress={onTopBarPress.bind(null, 'yourRequests')}
        >
            <Text style={{
                ...Styles.topBarBtnTxt,
                color: selectedTopBarBtn === 'yourRequests' ? Colors.color2 : Colors.color1
            }}>
    ...
    const getOthersRequests = (params = { page: 1, type: 5 }, othersRequestsList = othersRequests) => {
        ApiServices.getUsers(params).then((res: any) => {
    ...
    const getYourRequests = (params = { page: 1, type: 6 }, yourRequestsList = yourRequests) => {
        ApiServices.getUsers(params).then((res: any) => {
