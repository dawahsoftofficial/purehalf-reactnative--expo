...
import { AnimatedLoader, Button, ButtonPicker, Container, Header, Text, ModalLoader } from '../../components'
...
const BlockedList = (props: any) => {
    ...
    const getBlockedList = (params = { page: 1, type: 7 }, blockedListData = blockedList) => {
    ...
    const onButtonPickerButtonPress = (item: any) => {
        hideButtonPicker()
        let userId = buttonPickerVisible?.item?.id
        const { value } = item
        if (value === 'unBlock') {
            setModalLoader({
                visible: true,
        ...
        return (
            <View style={Styles.itemCon}>
                ...
                <View style={{ ...Styles.itemContentCon, flexDirection: Rtl ? 'row-reverse' : 'row' }}>
                    ...
                    <Ripple style={Styles.leftDownArrowCon}
            ...
            />
            {
                loader ?
                    ...
                    <FlatList
                        ...
                        ListFooterComponent={blockedList?.length >= 10 ? renderListFooter : null}
