...
const SavedSearches = () => {
        ...
        >
          ...
          >
            <Feather
              ...
              size={wp(4)}
              style={{
                marginRight: Rtl ? 0 : wp(2.5),
                marginLeft: Rtl ? wp(2.5) : 0,
              }}
            />
          </Ripple>
        </View>
  ...
  const renderEmptyList = () => (
    <View style={Styles.emptyListCon}>
      <Text style={Styles.emptyListText}>{LanguageKeys.noSaveSearches}</Text>
    </View>
  );
  return (
    <ScrollView
      ...
      {loader ? (
        ...
        <FlatList
          ...
          contentContainerStyle={{
            ...
            paddingTop: savedSearches.length === 0 ? hp(1) : hp(1),
          }}
          scrollEnabled={false}
