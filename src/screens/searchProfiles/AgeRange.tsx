...
const AgeRange = (props: any) => {
    const [ageRange, setAgeRange] = useState([{ label: LanguageKeys.any, value: LanguageKeys.any }])
    const {
        onClearPress = () => null
    } = props
    const Rtl = CheckRtl()
    ...
    const RenderDropDownBtn = ({ text, onPress }: any) => (
        <Ripple style={Styles.ageDropDownBtn}
            onPress={onPress}
        >
            <Text style={Styles.ageDropDownTxt}>
                {text}
            </Text>
            <AntDesign
                name='down'
    ...
    const RenderAgeRange = () => (
        <View style={{
            ...Styles.ageRangeCon, flexDirection: Rtl ? 'row-reverse' : 'row',
        }}>
            <Text style={Styles.fieldDesc}>
                {LanguageKeys.between}
            </Text>
            <RenderDropDownBtn
                text={minAge}
            ...
            <RenderDropDownBtn
                text={maxAge}
                onPress={openPicker.bind(null, 'end')}
            />
        </View>
    )
