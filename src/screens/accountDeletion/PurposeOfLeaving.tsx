...
const PurposeOfLeaving = (props: any) => {
    ...
    let phoneNumberFirebaseRes = props?.route?.params?.phoneNumberFirebaseRes
    ...
    const onRadioPress = (item: any, index: any) => setSelectedRadio({
        index: index,
        item: item,
    })
    ...
    const renderList = ({ item, index }: any) => {
        return (
            ...
            >
                <View style={{
                    ...Styles.radioBtn,
                    backgroundColor: index === selectedRadio.index ? Colors.color1 : 'transparent'
                }} />
