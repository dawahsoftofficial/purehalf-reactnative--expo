...
const Location = (props: any) => {
    ...
    const onUpdate = async () => {
        setLoading(true);
        let data = await getCountryAndCity(position?.latitude, position?.longitude)
        ApiServices.updateUserInfo({ latitude: position?.latitude, longitude: position?.longitude, country: data?.country, city: data?.city })
            .then(async res => {
