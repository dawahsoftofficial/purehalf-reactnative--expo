import { View, Modal, StyleSheet, TouchableOpacity, StatusBar, FlatList } from 'react-native'
...
const ButtonPicker = (props: any) => {
    ...
    const renderList = ({ item }: any) => {
        ...
        return (
            <Button
                buttonStyle={{ ...Styles.button, backgroundColor: value === 'cancel' ? Colors.color8 : Colors.theme }}
                text={label}
                onPress={onButtonPress.bind(null, item)}
                textStyle={{ color: value === 'cancel' ? Colors.color1 : Colors.color2 }}
            />
        )
    }
