 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.purehalf.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.purehalf'; // ios bundle id
const PACKAGE = 'com.purehalf'; // android package name
const NAME = 'PureHalf'; // app name
const EXPO_ACCOUNT_OWNER = 'expo-owner'; // expo account owner
const EAS_PROJECT_ID = 'c3e1075b-6fe7-4686-aa49-35b46a229044'; // eas project id
const SCHEME = 'PureHalf'; // app scheme
...
const _clientEnv = {
  ...
  NAME: NAME,
  SCHEME: SCHEME,
  BUNDLE_ID: BUNDLE_ID, //withEnvSuffix(BUNDLE_ID),
  PACKAGE: PACKAGE, // withEnvSuffix(PACKAGE),
